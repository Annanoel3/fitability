...
const ZONES = [
  ...
  { id: "left_shoulder",  label: "Left Shoulder",          front: [72, 22],  back: [28, 22]  },
  { id: "right_shoulder", label: "Right Shoulder",         front: [28, 22],  back: [72, 22]  },
  ...
  { id: "left_arm",       label: "Left Arm",               front: [83, 30],  back: [17, 30]  },
  { id: "right_arm",      label: "Right Arm",              front: [17, 30],  back: [83, 30]  },
  { id: "left_forearm",   label: "Left Forearm / Elbow",   front: [86, 41],  back: [14, 41]  },
  { id: "right_forearm",  label: "Right Forearm / Elbow",  front: [14, 41],  back: [86, 41]  },
  { id: "left_wrist",     label: "Left Wrist / Hand",      front: [89, 53],  back: [11, 53]  },
  { id: "right_wrist",    label: "Right Wrist / Hand",     front: [11, 53],  back: [89, 53]  },
  { id: "left_hip",       label: "Left Hip / Glute",       front: F(75.84, 143.28, 148, 148), back: [35, 48] },
  { id: "right_hip",      label: "Right Hip / Glute",      front: F(40.56, 143.28, 148, 146), back: [65, 48] },
  { id: "left_thigh",     label: "Left Thigh",             front: [64, 58],  back: [36, 60]  },
  { id: "right_thigh",    label: "Right Thigh",            front: [36, 58],  back: [64, 60]  },
  { id: "left_knee",      label: "Left Knee",              front: [64, 69],  back: [36, 69]  },
  { id: "right_knee",     label: "Right Knee",             front: [36, 69],  back: [64, 69]  },
  { id: "left_calf",      label: "Left Shin / Calf",       front: F(86.64, 259.92, 103, 204), back: [36, 79]  },
  { id: "right_calf",     label: "Right Shin / Calf",      front: F(40.8, 260.4, 103, 209),   back: [64, 79]  },
  { id: "left_foot",      label: "Left Foot / Ankle",      front: F(87.12, 308.64, 70, 85),   back: [36, 92]  },
      ...
      <div className="flex justify-center">
        <div className="relative select-none" style={{ height: `${BOX_H}px`, width: `${imgW}px` }}>
          <img
            ...
            style={{ position: "absolute", left: view === "back" ? "39px" : 0, top: 0, width: "100%", height: "100%", transform: view === "back" ? "scale(1.3)" : "scale(1)", transformOrigin: "center" }}
            draggable={false}
          />
