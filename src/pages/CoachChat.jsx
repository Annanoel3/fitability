...
export default function CoachChat() {
  ...
  return (
    <div className="flex flex-col h-screen max-w-2xl mx-auto">
      {/* Header */}
      <div className="flex items-center gap-3 px-4 py-2 border-b border-border bg-card rounded-t-2xl flex-shrink-0">
      ...
      {/* Input */}
      <div className={`px-4 py-1.5 border-t border-border bg-card rounded-b-2xl flex-shrink-0 ${isTourCoachMessage ? "pointer-events-none" : ""}`}>
