...
export default function CoachChat() {
  ...
  return (
    <div className="flex flex-col h-full max-w-2xl mx-auto overflow-hidden">
      {/* Header */}
      <div className="flex items-center gap-3 border-b border-border bg-card rounded-t-2xl px-4 py-2">
      ...
      {/* Messages */}
      <div className="flex-1 overflow-y-auto px-4 pt-4 bg-background">
        {messages.length === 0 &&
      ...
      {/* Input */}
      <div className={`border-t border-border bg-card rounded-b-2xl flex-shrink-0 px-4 py-2 ${isTourCoachMessage ? "pointer-events-none" : ""}`}>
